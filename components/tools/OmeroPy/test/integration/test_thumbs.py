...
class TestThumbs(ITest):
    ...
    def testThumbnailVersion(self, meth):
        """
        The test verifies thumbnail version
        handling when a missing pyramid
        is generated by OMERO during thumbnail creation.
        It depends on OMERO generating pyramids during the
        test run.
        """
